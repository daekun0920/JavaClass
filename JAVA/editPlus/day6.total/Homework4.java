...
출력) 짜장면 : 17시 20분
	...
	BufferedReader reader = new BufferedReader(new InputStreamReader(System.in)); // 발표할때 중요한부분과 덜 중요한 부분을 따로 분리하기
	...
	today.set(Calendar.MONTH, month - 1);  // Calendar.MONTH = 0 ~ 11 이라서 입력받은값에서 1을 빼준뒤 나중에 출력할때 1을 다시 더해준다.
	today.set(Calendar.DATE, day);		   // 들여쓰기 조금 더  
	//Calendar.MONTH는 고유의 값(2)을 가지고 있어서 괄호 밖에서 더해야함
