...
//	public static ArrayList<Reservation> reservationList; // Reservation eserveList
//	
...
//	public static ArrayList<Wish> wishList; // wish wishList
	...
	public static void memberListSave() {
		try {
			...
			for(int i=0; i<Business.memberList.size(); i++) {
				String line = String.format("%s\t%s\t%s\t%s\t%s\t%s\t%s\r\n", Business.memberList.get(i).getUserId()
																		  , Business.memberList.get(i).getUserPw()
																		  , Business.memberList.get(i).getMemberType()
																		  , Business.memberList.get(i).getUserName()
																		  , Business.memberList.get(i).getUserBirth()
																		  , Business.memberList.get(i).getUserTel()
																		  , Business.memberList.get(i).getUserEmail());
				writer.write(line);
			}
			writer.close();
...
*/			
			for(int i=0; i<Business.storeList.size(); i++) {
				String line = String.format("%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\r\n", Business.storeList.get(i).getStoreId()
																			  , Business.storeList.get(i).getStoreName()
																			  , Business.storeList.get(i).getStoreAddress()
																			  , Business.storeList.get(i).getStoreCategory()
																			  , Business.storeList.get(i).getStoreTel()
																			  , Business.storeList.get(i).getFavorite()+""
																			  , Business.storeList.get(i).getTag()
																			  , Business.storeList.get(i).getMenu());
				writer.write(line);
			}
			writer.close();
	...
	public static void boardListSave() {
		try {
			...
			for(int i=0; i<BoardList.boardList.size(); i++) {
				String line = String.format("%s\t%s\t%s\t%s\t%s\r\n", BoardList.boardList.get(i).getBoardIndex()
																  , BoardList.boardList.get(i).getBoardId()
																  , BoardList.boardList.get(i).getBoardPw()
																  , BoardList.boardList.get(i).getBoardContent()
																  , BoardList.boardList.get(i).getWritingTime());
				writer.write(line);
			}
...
*/			
			for(int i=0; i<Reservation.reserveList.size(); i++) {
				String line = String.format("%s\t%s\t%s\t%s\r\n", Reservation.reserveList.get(i).getUserId()
															  , Reservation.reserveList.get(i).getStoreName()
															  , Reservation.reserveList.get(i).getStoreAddress()
															  , Reservation.reserveList.get(i).getStoreTel());
				writer.write(line);
			}
			writer.close();
		...
		try {
			...
			*/	
			...
			for(int i=0; i<Wish.wishList.size(); i++) {
				String line = String.format("%s\t%s\t%s\t%s\t%s\r\n", Wish.wishList.get(i).getMyId()
																  , Wish.wishList.get(i).getMyStoreName()
																  , Wish.wishList.get(i).getMyStoreAddress()
																  , Wish.wishList.get(i).getMyStoreCategory()
																  , Wish.wishList.get(i).getMyStoreTel());
				writer.write(line);
			}
			writer.close();
