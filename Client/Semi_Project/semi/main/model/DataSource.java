...
public class DataSource {
	...
	public DataSource() {
		...
		path.add(".\\semi\\anony\\model\\sql");
		path.add(".\\semi\\main\\model\\sql");
		path.add(".\\semi\\managercomm\\model\\sql");
		path.add(".\\semi\\managerpost\\model\\sql");
		path.add(".\\semi\\managerreg\\model\\sql");
		path.add(".\\semi\\member\\model\\sql");
		path.add(".\\semi\\membercomm\\model\\sql");
		path.add(".\\semi\\memberpost\\model\\sql");
		path.add(".\\semi\\anony\\model\\sql");
